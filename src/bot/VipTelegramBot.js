...
class VipTelegramBot {
  #bot; #onboardingService; #guestMenuService; #guestRegistryService; #adminCommandService; #adminProductDialogService; #adminQuantityDialogService; #adminBroadcastDialogService; #userShoppingFlowService; #adminId;
  constructor(token, onboardingService, guestMenuService, guestRegistryService, adminCommandService, adminProductDialogService, adminQuantityDialogService, adminBroadcastDialogService, userShoppingFlowService, adminId) {
    ...
    this.#adminBroadcastDialogService = adminBroadcastDialogService; this.#userShoppingFlowService = userShoppingFlowService; this.#adminId = adminId;
  }
  ...
  async #handleIncomingMessage(msg) {
    ...
    const cancel = msg.text === '/cancel' ? this.#adminProductDialogService.cancel(chatId) || this.#adminQuantityDialogService.cancel(chatId) || this.#adminBroadcastDialogService.cancel(chatId) : null;
